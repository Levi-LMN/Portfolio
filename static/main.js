                        ...
                        n.prototype.show = function() {
                            ...
                            if (this.hasContent() && this.enabled) {
                                ...
                                if (u) {
                                    ...
                                    a = "bottom" == a && c.bottom + f > h.bottom ? "top" : "top" == a && c.top - f < h.top ? "bottom" : "right" == a && c.right + p > h.width ? "left" : "left" == a && c.left - p < h.left ? "right" : a,
    ...
    aWFY: function(t, e, n) {
        ...
        (function(t) {
                ...
                function o() {
                    ...
                    "/" == location.pathname && t('nav li a[href="./index.html"]').addClass("active")
                }
                function r() {
    ...
    juYr: function(t, e, n) {
        ...
        !function(e, n) {
            ...
            function u(t, e, n) {
                ...
                }) : Dt.test(e) ? yt.filter(e, t, n) : (e = yt.filter(e, t),
            ...
            function b(t, e, n, i) {
                var o, r = 1, s = 20, a = i ? function() {
                    ...
                    , l = a(), u = n && n[3] || (yt.cssNumber[e] ? "" : "px"), c = (yt.cssNumber[e] || "px" !== u && +l) && _t.exec(yt.css(t, e));
                if (c && c[3] !== u) {
                    u = u || c[3],
                        n = n || [],
                        c = +l || 1;
            ...
            function w(t, e) {
                for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
                    ...
                    i.style && (n = i.style.display,
                        ...
                        o[r] || (i.style.display = "")),
                        "" === i.style.display && zt(i) && (o[r] = x(i))) : "none" !== n && (o[r] = "none",
                            Ht.set(i, "display", n)));
                for (r = 0; r < s; r++)
            ...
            function k(t, e, n, i, o) {
                ...
                for (p.textContent = "",
                    ...
                    if (i && yt.inArray(r, i) > -1)
                        o && o.push(r);
                    else if (u = yt.contains(r.ownerDocument, r),
            ...
            function P(t, e, n, i) {
                ...
                if (g || f > 1 && "string" == typeof h && !vt.checkClone && re.test(h))
                    return t.each(function(o) {
                        var r = t.eq(o);
                        g && (e[0] = h.call(this, o, r.html())),
                            P(r, e, n, i)
                    });
                if (f && (o = k(e, t[0].ownerDocument, !1, t, i),
                    r = o.firstChild,
                1 === o.childNodes.length && (o = r),
                r || i)) {
                    for (a = yt.map(T(o, "script"), A),
                             l = a.length; p < f; p++)
                        u = o,
                        p !== d && (u = yt.clone(u, !0, !0),
                        l && yt.merge(a, T(u, "script"))),
                            n.call(t[p], u, p);
                    if (l)
                        for (c = a[a.length - 1].ownerDocument,
                                 ...
                                 p = 0; p < l; p++)
                            u = a[p],
                            Gt.test(u.type || "") && !Ht.access(u, "globalEval") && yt.contains(c, u) && (u.src ? yt._evalUrl && yt._evalUrl(u.src) : s(u.textContent.replace(ae, ""), c))
                }
                return t
            }
            function L(t, e, n) {
                for (var i, o = e ? yt.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
                    ...
                    i.parentNode && (n && yt.contains(i.ownerDocument, i) && C(T(i, "script")),
            ...
            function q(t, e, n) {
                ...
                !vt.pixelMarginRight() && ue.test(s) && le.test(e) && (i = a.width,
                    o = a.minWidth,
                    r = a.maxWidth,
            ...
            function F(t) {
                var e = yt.cssProps[t];
                return e || (e = yt.cssProps[t] = H(t) || t),
                    e
            }
            function M(t, e, n) {
                var i = _t.exec(e);
            ...
            function B(t, e, n, i, o) {
                ...
                for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
                    "margin" === n && (s += yt.css(t, n + Ut[r], !0, o)),
                        i ? ("content" === n && (s -= yt.css(t, "padding" + Ut[r], !0, o)),
                        "margin" !== n && (s -= yt.css(t, "border" + Ut[r] + "Width", !0, o))) : (s += yt.css(t, "padding" + Ut[r], !0, o),
                        "padding" !== n && (s += yt.css(t, "border" + Ut[r] + "Width", !0, o)));
                return s
            }
            function W(t, e, n) {
                var i, o = ce(t), r = q(t, e, o), s = "border-box" === yt.css(t, "boxSizing", !1, o);
                return ue.test(r) ? r : (i = s && (vt.boxSizingReliable() || r === t.style[e]),
                "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]),
                (r = parseFloat(r) || 0) + B(t, e, n || (s ? "border" : "content"), i, o) + "px")
            }
            function _(t, e, n, i, o) {
                return new _.prototype.init(t,e,n,i,o)
            }
            function U() {
                ye && (!1 === st.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(U) : n.setTimeout(U, yt.fx.interval),
                    yt.fx.tick())
            }
            function z() {
            ...
            function X(t, e, n) {
                var i, o, r, s, a, l, u, c, p = "width"in e || "height"in e, f = this, d = {}, h = t.style, g = t.nodeType && zt(t), m = Ht.get(t, "fxshow");
                n.queue || (s = yt._queueHooks(t, "fx"),
                null == s.unqueued && (s.unqueued = 0,
                    ...
                    f.always(function() {
                        f.always(function() {
                            s.unqueued--,
                            yt.queue(t, "fx").length || s.empty.fire()
                        })
                    }));
                for (i in e)
                    if (o = e[i],
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
                    ...
                    "none" === c && (u ? c = u : (w([t], !0),
                        ...
                        c = yt.css(t, "display"),
                        w([t]))),
                    ("inline" === c || "inline-block" === c && null != u) && "none" === yt.css(t, "float") && (l || (f.done(function() {
                        h.display = u
                    }),
                    null == u && (c = h.display,
                        u = "none" === c ? "" : c)),
            ...
            function G(t, e, n) {
                var i, o, r = 0, s = G.prefilters.length, a = yt.Deferred().always(function() {
                    ...
                    return a.notifyWith(t, [u, r, n]),
                        r < 1 && l ? n : (l || a.notifyWith(t, [u, 1, 0]),
                            a.resolveWith(t, [u]),
                            !1)
                }, u = a.promise({
                    elem: t,
                ...
                for (Q(c, u.opts.specialEasing); r < s; r++)
                    if (i = G.prefilters[r].call(u, t, c, u.opts))
                        return yt.isFunction(i.stop) && (yt._queueHooks(u.elem, u.opts.queue).stop = yt.proxy(i.stop, i)),
                            i;
                return yt.map(c, Y, u),
                yt.isFunction(u.opts.start) && u.opts.start.call(t, u),
                    u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always),
                    yt.fx.timer(yt.extend(l, {
                        elem: t,
                        anim: u,
                        queue: u.opts.queue
                    })),
                    ...
                    for ("boolean" == typeof s && (u = s,
                        ...
                        if (null != (t = arguments[a]))
                            for (e in t)
                                n = s[e],
                                    i = t[e],
                                s !== i && (u && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1,
                                    r = n && Array.isArray(n) ? n : []) : r = n && yt.isPlainObject(n) ? n : {},
                                    s[e] = yt.extend(u, r, i)) : void 0 !== i && (s[e] = i));
                    return s
                }
                ,
                yt.extend({
                    ...
                    makeArray: function(t, e) {
                        var n = e || [];
                        return null != t && (a(Object(t)) ? yt.merge(n, "string" == typeof t ? [t] : t) : ct.call(n, t)),
                            n
                    },
            ...
            "function" == typeof Symbol && (yt.fn[Symbol.iterator] = rt[Symbol.iterator]),
            ...
            var Ct = function(t) {
                function e(t, e, n, i) {
                    ...
                    "string" != typeof t || !t || 1 !== h && 9 !== h && 11 !== h)
                        return n;
                    if (!i && ((e ? e.ownerDocument || e : F) !== j && A(e),
                        e = e || j,
                        I)) {
                        if (11 !== h && (l = gt.exec(t)))
                            if (o = l[1]) {
                        ...
                        if (x.qsa && !U[t + " "] && (!P || !P.test(t))) {
                            if (1 !== h)
                                ...
                                for ((a = e.getAttribute("id")) ? a = a.replace(bt, xt) : e.setAttribute("id", a = H),
                                    ...
                                    c[r] = "#" + a + " " + p(c[r]);
                                f = c.join(","),
                                    d = mt.test(t) && u(e.parentNode) || e
                            }
                            if (f)
                                try {
                                    return G.apply(n, d.querySelectorAll(f)),
                                        n
                                } catch (t) {} finally {
                ...
                function m(t, e, n, o, r, s) {
                    ...
                    r && !r[H] && (r = m(r, s)),
                        i(function(i, s, a, l) {
                            var u, c, p, f = [], d = [], m = s.length, v = i || h(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : g(v, f, t, a, l), b = n ? r || (i ? t : m || o) ? [] : s : y;
                            if (n && n(y, b, a, l),
                                o)
                                for (u = g(b, d),
                                         o(u, [], a, l),
                ...
                function y(t, n) {
                    var o = n.length > 0
                        ...
                        var c, p, f, d = 0, h = "0", m = i && [], v = [], y = $, b = i || r && w.find.TAG("*", u), x = M += null == y ? 1 : Math.random() || .1, T = b.length;
                        for (u && ($ = s === j || s || u); h !== T && null != (c = b[h]); h++) {
                            if (r && c) {
                                for (p = 0,
                                     s || c.ownerDocument === j || (A(c),
                                         a = !I); f = t[p++]; )
                                    if (f(c, s || j, a)) {
                                        l.push(c);
                                        break
                ...
                var b, x, w, T, C, k, E, S, $, D, N, A, j, O, I, P, L, q, R, H = "sizzle" + 1 * new Date, F = t.document, M = 0, B = 0, W = n(), _ = n(), U = n(), z = function(t, e) {
                    return t === e && (N = !0),
                        0
                    ...
                    for (var n = 0, i = t.length; n < i; n++)
                        if (t[n] === e)
                            return n;
                    return -1
                }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", it = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", ot = new RegExp(tt + "+","g"), rt = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$","g"), st = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), lt = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]","g"), ut = new RegExp(it), ct = new RegExp("^" + et + "$"), pt = {
                    ID: new RegExp("^#(" + et + ")"),
                    CLASS: new RegExp("^\\.(" + et + ")"),
                    TAG: new RegExp("^(" + et + "|[*])"),
                    ATTR: new RegExp("^" + nt),
                ...
                }, ft = /^(?:input|select|textarea|button)$/i, dt = /^h\d$/i, ht = /^[^{]+\{\s*\[native \w/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/, vt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)","ig"), yt = function(t, e, n) {
                    var i = "0x" + e - 65536;
                ...
                x = e.support = {},
                    ...
                    A = e.setDocument = function(t) {
                        ...
                        return i !== j && 9 === i.nodeType && i.documentElement ? (j = i,
                            O = j.documentElement,
                            I = !C(j),
                        F !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)),
                            ...
                            L = [],
                            P = [],
                        (x.qsa = ht.test(j.querySelectorAll)) && (o(function(t) {
                            O.appendChild(t).innerHTML = "<a id='" + H + "'></a><select id='" + H + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                            t.querySelectorAll("[msallowcapture^='']").length && P.push("[*^$]=" + tt + "*(?:''|\"\")"),
                            t.querySelectorAll("[selected]").length || P.push("\\[" + tt + "*(?:value|" + Z + ")"),
                            t.querySelectorAll("[id~=" + H + "-]").length || P.push("~="),
                            t.querySelectorAll(":checked").length || P.push(":checked"),
                            t.querySelectorAll("a#" + H + "+*").length || P.push(".#.+[+~]")
                        }),
                            o(function(t) {
                        ...
                        (x.matchesSelector = ht.test(q = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function(t) {
                            ...
                            R = e || ht.test(O.contains) ? function(t, e) {
                            ...
                            z = e ? function(t, e) {
                                    ...
                                    return n || (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1,
                                        1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === j || t.ownerDocument === F && R(F, t) ? -1 : e === j || e.ownerDocument === F && R(F, e) ? 1 : D ? J(D, t) - J(D, e) : 0 : 4 & n ? -1 : 1)
                                }
                                : function(t, e) {
                                    if (t === e)
                                        return N = !0,
                    ...
                    e.matchesSelector = function(t, n) {
                        if ((t.ownerDocument || t) !== j && A(t),
                            n = n.replace(lt, "='$1']"),
                        x.matchesSelector && I && !U[n + " "] && (!L || !L.test(n)) && (!P || !P.test(n)))
                            try {
                                var i = q.call(t, n);
                    ...
                    e.contains = function(t, e) {
                        return (t.ownerDocument || t) !== j && A(t),
                            R(t, e)
                    }
                    ,
                    e.attr = function(t, e) {
                    ...
                    w = e.selectors = {
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function(t) {
                                var e, n = !t[6] && t[2];
                                return pt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ut.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                                    t[2] = n.slice(0, e)),
                                    t.slice(0, 3))
                            }
                        },
                        filter: {
                            ...
                            CHILD: function(t, e, n, i, o) {
                                ...
                                return 1 === i && 0 === o ? function(t) {
                                    ...
                                    : function(e, n, l) {
                                        var u, c, p, f, d, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, b = !1;
                                        if (m) {
                                            if (r) {
                                                for (; g; ) {
                                                    for (f = e; f = f[g]; )
                                            ...
                                            s && y) {
                                                ...
                                                b = d),
                                            !1 === b)
                                                for (; (f = ++d && f && f[g] || (b = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (p = f[H] || (f[H] = {}),
                                                    c = p[f.uniqueID] || (p[f.uniqueID] = {}),
                                                    c[t] = [M, b]),
                                                f !== e)); )
                                                    ;
                ...
                return c.prototype = w.filters = w.pseudos,
                    ...
                    S = e.select = function(t, e, n, i) {
                        ...
                        return (c || E(t, f))(i, e, !I, n, !e || mt.test(t) && u(e.parentNode) || e),
                            n
                    }
                    ,
            ...
            yt.filter = function(t, e, n) {
                var i = e[0];
                return n && (t = ":not(" + t + ")"),
                    1 === e.length && 1 === i.nodeType ? yt.find.matchesSelector(i, t) ? [i] : [] : yt.find.matches(t, yt.grep(e, function(t) {
                        return 1 === t.nodeType
                    }))
            }
                ,
            ...
            (yt.fn.init = function(t, e, n) {
                    ...
                    "string" == typeof t) {
                        ...
                        if (i[1]) {
                            if (e = e instanceof yt ? e[0] : e,
                                yt.merge(this, yt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : st, !0)),
                    ...
                    return t.nodeType ? (this[0] = t,
                        this.length = 1,
                        this) : yt.isFunction(t) ? void 0 !== n.ready ? n.ready(t) : t(yt) : yt.makeArray(t, this)
                }
            ).prototype = yt.fn,
                Nt = yt(st);
            ...
            yt.fn.extend({
                ...
                yt.each({
                    ...
                    yt.fn[t] = function(n, i) {
                        ...
                        this.length > 1 && (Ot[t] || yt.uniqueSort(o),
                        jt.test(t) && o.reverse()),
                            this.pushStack(o)
                    }
                });
                            ...
                            then: function(t, i, o) {
                                function r(t, e, i, o) {
                                    return function() {
                                        var a = this
                                            ...
                                            , u = function() {
                                                ...
                                                if (!(t < s)) {
                                                    ...
                                                    u = n && ("object" == typeof n || "function" == typeof n) && n.then,
                                                        yt.isFunction(u) ? o ? u.call(n, r(s, e, f, o), r(s, e, d, o)) : (s++,
                                                            u.call(n, r(s, e, f, o), r(s, e, d, o), r(s, e, f, e.notifyWith))) : (i !== f && (a = void 0,
                                                            l = [n]),
                                                            (o || e.resolveWith)(a, l))
                                                }
                                            }
                                            , c = o ? u : function() {
                                                try {
                                                    ...
                                                    yt.Deferred.exceptionHook && yt.Deferred.exceptionHook(n, c.stackTrace),
                                                    t + 1 >= s && (i !== d && (a = void 0,
                                                        l = [n]),
                                                        e.rejectWith(a, l))
                                                }
                                        ...
                                        ;
                                        t ? c() : (yt.Deferred.getStackHook && (c.stackTrace = yt.Deferred.getStackHook()),
                                            n.setTimeout(c))
                                    }
                                }
                                var s = 0;
                                return yt.Deferred(function(n) {
                                    e[0][3].add(r(0, n, yt.isFunction(o) ? o : f, n.notifyWith)),
            ...
            yt.fn.ready = function(t) {
                ...
                yt.extend({
                    ...
                    readyWait: 1,
                    ready: function(t) {
                        (!0 === t ? --yt.readyWait : yt.isReady) || (yt.isReady = !0,
                        !0 !== t && --yt.readyWait > 0 || Lt.resolveWith(st, [yt]))
                    }
                }),
                yt.ready.then = Lt.then,
                "complete" === st.readyState || "loading" !== st.readyState && !st.documentElement.doScroll ? n.setTimeout(yt.ready) : (st.addEventListener("DOMContentLoaded", g),
            ...
            m.uid = 1,
                m.prototype = {
                    ...
                    remove: function(t, e) {
                        ...
                        if (void 0 !== i) {
                            if (void 0 !== e) {
                                Array.isArray(e) ? e = e.map(yt.camelCase) : (e = yt.camelCase(e),
            ...
            yt.extend({
                ...
                yt.fn.extend({
                    data: function(t, e) {
                        ...
                        if (void 0 === t) {
                            if (this.length && (o = Ft.get(r),
                            1 === r.nodeType && !Ht.get(r, "hasDataAttrs"))) {
                                for (n = s.length; n--; )
                                    s[n] && (i = s[n].name,
                                    0 === i.indexOf("data-") && (i = yt.camelCase(i.slice(5)),
                                        y(r, i, o[i])));
                ...
                yt.extend({
                    queue: function(t, e, n) {
                        ...
                        if (t)
                            return e = (e || "fx") + "queue",
                                i = Ht.get(t, e),
                            n && (!i || Array.isArray(n) ? i = Ht.access(t, e, yt.makeArray(n)) : i.push(n)),
                            i || []
                    },
                ...
                yt.fn.extend({
                    queue: function(t, e) {
                        ...
                        return "string" != typeof t && (e = t,
                            t = "fx",
                            n--),
                            arguments.length < n ? yt.queue(this[0], t) : void 0 === e ? this : this.each(function() {
                    ...
                    promise: function(t, e) {
                        ...
                        for ("string" != typeof t && (e = t,
                            t = void 0),
                                 t = t || "fx"; s--; )
                            (n = Ht.get(r[s], t + "queueHooks")) && n.empty && (i++,
                                n.empty.add(a));
                        return a(),
                            o.promise(e)
                    }
            ...
            var Wt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
                ...
                , zt = function(t, e) {
                return t = e || t,
                "none" === t.style.display || "" === t.style.display && yt.contains(t.ownerDocument, t) && "none" === yt.css(t, "display")
            }
                , Vt = function(t, e, n, i) {
                var o, r, s = {};
                for (r in e)
            ...
            yt.event = {
                ...
                add: function(t, e, n, i, o) {
                    ...
                    if (m)
                        for (n.handler && (r = n,
                            ...
                            (f = l[d]) || (f = l[d] = [],
                                f.delegateCount = 0,
                            p.setup && !1 !== p.setup.call(t, i, h, s) || t.addEventListener && t.addEventListener(d, s)),
                    ...
                    if (m && (l = m.events)) {
                        for (e = (e || "").match(It) || [""],
                            ...
                            if (a = ne.exec(e[u]) || [],
                                ...
                                h = (a[2] || "").split(".").sort(),
                                d) {
                                for (p = yt.event.special[d] || {},
                                         d = (i ? p.delegateType : p.bindType) || d,
                                         f = l[d] || [],
                                         a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                                         s = r = f.length; r--; )
                                    c = f[r],
                                    !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(r, 1),
                                    c.selector && f.delegateCount--,
                                    p.remove && p.remove.call(t, c));
                                s && !f.length && (p.teardown && !1 !== p.teardown.call(t, h, m.handle) || yt.removeEvent(t, d, m.handle),
                                    delete l[d])
                            } else
                                for (d in l)
                ...
                dispatch: function(t) {
                    var e, n, i, o, r, s, a = yt.event.fix(t), l = new Array(arguments.length), u = (Ht.get(this, "events") || {})[a.type] || [], c = yt.event.special[a.type] || {};
                    for (l[0] = a,
                             e = 1; e < arguments.length; e++)
                        l[e] = arguments[e];
                    if (a.delegateTarget = this,
                    !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                        for (s = yt.event.handlers.call(this, a, u),
                            ...
                            for (a.currentTarget = o.elem,
                                ...
                                a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r,
                                    a.data = r.data,
                                void 0 !== (i = ((yt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(),
                                    a.stopPropagation()));
                        ...
                        for (; u !== this; u = u.parentNode || this)
                            if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                                for (r = [],
                                    ...
                                    i = e[n],
                                        o = i.selector + " ",
                                    void 0 === s[o] && (s[o] = i.needsContext ? yt(o, this).index(u) > -1 : yt.find(o, this, null, [u]).length),
                                    s[o] && r.push(i);
                                r.length && a.push({
                                    elem: u,
                                    handlers: r
                ...
                yt.Event = function(t, e) {
                    ...
                    t && t.type ? (this.originalEvent = t,
                        this.type = t.type,
                        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? E : S,
                ...
                yt.each({
                    ...
                    yt.event.special[t] = {
                        ...
                        handle: function(t) {
                            ...
                            return o && (o === i || yt.contains(i, o)) || (t.type = r.origType,
                    ...
                    off: function(t, e, n) {
                        ...
                        if (t && t.preventDefault && t.handleObj)
                            return i = t.handleObj,
                                yt(t.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler),
                                this;
                        if ("object" == typeof t) {
                            for (o in t)
                                this.off(o, e, t[o]);
                ...
                yt.fn.extend({
                    ...
                    empty: function() {
                        for (var t, e = 0; null != (t = this[e]); e++)
                            1 === t.nodeType && (yt.cleanData(T(t, !1)),
                                t.textContent = "");
                        return this
                    },
                    clone: function(t, e) {
                        ...
                        return qt(this, function(t) {
                            ...
                            if ("string" == typeof t && !oe.test(t) && !Kt[(Qt.exec(t) || ["", ""])[1].toLowerCase()]) {
                                ...
                                try {
                                    for (; n < i; n++)
                                        e = this[n] || {},
                                        1 === e.nodeType && (yt.cleanData(T(e, !1)),
                                            e.innerHTML = t);
                                    e = 0
                                } catch (t) {}
                            }
                    ...
                    replaceWith: function() {
                        ...
                        return P(this, arguments, function(e) {
                            ...
                            yt.inArray(this, t) < 0 && (yt.cleanData(T(this)),
            ...
            yt.extend({
                ...
                style: function(t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        r = typeof n,
                        "string" === r && (o = _t.exec(n)) && o[1] && (n = b(t, e, o),
                            r = "number"),
                        null != n && n === n && ("number" === r && (n += o && o[3] || (yt.cssNumber[a] ? "" : "px")),
                ...
                yt.each(["height", "width"], function(t, e) {
                    yt.cssHooks[e] = {
                        ...
                        set: function(t, n, i) {
                            ...
                            return s && (o = _t.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n,
                                n = yt.css(t, e)),
                                M(t, n, s)
                        }
                    }
            ...
            yt.Animation = yt.extend(G, {
                ...
                yt.speed = function(t, e, n) {
                    ...
                    return yt.fx.off ? i.duration = 0 : "number" != typeof i.duration && (i.duration in yt.fx.speeds ? i.duration = yt.fx.speeds[i.duration] : i.duration = yt.fx.speeds._default),
                ...
                yt.fn.extend({
                    ...
                    finish: function(t) {
                        return !1 !== t && (t = t || "fx"),
                            this.each(function() {
                                var e, n = Ht.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = yt.timers, s = i ? i.length : 0;
                                for (n.finish = !0,
                                         yt.queue(this, t, []),
                ...
                yt.fn.delay = function(t, e) {
                    return t = yt.fx ? yt.fx.speeds[t] || t : t,
                        e = e || "fx",
            ...
            yt.fn.extend({
                ...
                yt.extend({
                    attr: function(t, e, n) {
                        ...
                        if (3 !== r && 8 !== r && 2 !== r)
                            return void 0 === t.getAttribute ? yt.prop(t, e, n) : (1 === r && yt.isXMLDoc(t) || (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? we : void 0)),
                                void 0 !== n ? null === n ? void yt.removeAttr(t, e) : o && "set"in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""),
                                    n) : o && "get"in o && null !== (i = o.get(t, e)) ? i : (i = yt.find.attr(t, e),
                                    null == i ? void 0 : i))
                    },
                    attrHooks: {
                        type: {
                ...
                we = {
                    set: function(t, e, n) {
                        return !1 === e ? yt.removeAttr(t, n) : t.setAttribute(n, n),
                            n
                    }
                },
            ...
            yt.fn.extend({
                ...
                yt.extend({
                    prop: function(t, e, n) {
                        var i, o, r = t.nodeType;
                        if (3 !== r && 8 !== r && 2 !== r)
                            return 1 === r && yt.isXMLDoc(t) || (e = yt.propFix[e] || e,
                                o = yt.propHooks[e]),
            ...
            yt.fn.extend({
                val: function(t) {
                    ...
                    {
                        if (arguments.length)
                            return i = yt.isFunction(t),
                                this.each(function(n) {
                                    var o;
                                    1 === this.nodeType && (o = i ? t.call(this, n, yt(this).val()) : t,
                                        null == o ? o = "" : "number" == typeof o ? o += "" : Array.isArray(o) && (o = yt.map(o, function(t) {
                                            return null == t ? "" : t + ""
                                        })),
                                    (e = yt.valHooks[this.type] || yt.valHooks[this.nodeName.toLowerCase()]) && "set"in e && void 0 !== e.set(this, o, "value") || (this.value = o))
                                });
                        if (o)
                            return (e = yt.valHooks[o.type] || yt.valHooks[o.nodeName.toLowerCase()]) && "get"in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value,
                ...
                yt.extend({
                    valHooks: {
                        ...
                        select: {
                            get: function(t) {
                                var e, n, i, o = t.options, r = t.selectedIndex, s = "select-one" === t.type, a = s ? null : [], u = s ? r + 1 : o.length;
                                for (i = r < 0 ? u : s ? r : 0; i < u; i++)
                                    if (n = o[i],
                                    (n.selected || i === r) && !n.disabled && (!n.parentNode.disabled || !l(n.parentNode, "optgroup"))) {
                                        if (e = yt(n).val(),
                                            s)
                                            return e;
                                        a.push(e)
                            ...
                            set: function(t, e) {
                                for (var n, i, o = t.options, r = yt.makeArray(e), s = o.length; s--; )
                                    i = o[s],
                                    (i.selected = yt.inArray(yt.valHooks.option.get(i), r) > -1) && (n = !0);
            ...
            yt.extend(yt.event, {
                trigger: function(t, e, i, o) {
                    var r, s, a, l, u, c, p, f = [i || st], d = ht.call(t, "type") ? t.type : t, h = ht.call(t, "namespace") ? t.namespace.split(".") : [];
                    if (s = a = i = i || st,
                    3 !== i.nodeType && 8 !== i.nodeType && !Se.test(d + yt.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."),
                        d = h.shift(),
                        h.sort()),
                        u = d.indexOf(":") < 0 && "on" + d,
                    ...
                    o || !p.trigger || !1 !== p.trigger.apply(i, e))) {
                        ...
                        for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
                            ...
                            c && c.apply(s, e),
                            (c = u && s[u]) && c.apply && Rt(s) && (t.result = c.apply(s, e),
                            !1 === t.result && t.preventDefault());
                        return t.type = d,
                        o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), e) || !Rt(i) || u && yt.isFunction(i[d]) && !yt.isWindow(i) && (a = i[u],
                        a && (i[u] = null),
            ...
            Ue.href = $e.href,
                    ...
                    ajax: function(t, e) {
                        function i(t, e, i, a) {
                            ...
                            i && (x = it(h, C, i)),
                                ...
                                C.statusCode(b),
                                b = void 0,
                            p && m.trigger(u ? "ajaxSuccess" : "ajaxError", [C, h, u ? f : d]),
                                y.fireWith(g, [C, T]),
                            p && (m.trigger("ajaxComplete", [C, h]),
                            --yt.active || yt.event.trigger("ajaxStop")))
                        }
                        "object" == typeof t && (e = t,
                            t = void 0),
                            e = e || {};
                        var o, r, s, a, l, u, c, p, f, d, h = yt.ajaxSetup({}, e), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? yt(g) : yt.event, v = yt.Deferred(), y = yt.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                            readyState: 0,
                        ...
                        if (v.promise(C),
                            h.url = ((t || h.url || $e.href) + "").replace(Me, $e.protocol + "//"),
                        ...
                        null == h.crossDomain) {
                            ...
                            try {
                                u.href = h.url,
                                    u.href = u.href,
                                    h.crossDomain = Ue.protocol + "//" + Ue.host != u.protocol + "//" + u.host
                            } catch (t) {
                                h.crossDomain = !0
                            }
                        }
                        ...
                        p && 0 == yt.active++ && yt.event.trigger("ajaxStart"),
                            ...
                            r = h.url.replace(Le, ""),
                            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pe, "+")) : (d = h.url.slice(r.length),
                            h.data && (r += (Ne.test(r) ? "&" : "?") + h.data,
                                delete h.data),
                            !1 === h.cache && (r = r.replace(qe, "$1"),
                                d = (Ne.test(r) ? "&" : "?") + "_=" + De++ + d),
                                h.url = r + d),
                        h.ifModified && (yt.lastModified[r] && C.setRequestHeader("If-Modified-Since", yt.lastModified[r]),
                        ...
                        (h.data && h.hasContent && !1 !== h.contentType || e.contentType) && C.setRequestHeader("Content-Type", h.contentType),
                            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + _e + "; q=0.01" : "") : h.accepts["*"]);
                        for (f in h.headers)
                ...
                yt.fn.extend({
                    wrapAll: function(t) {
                        var e;
                        return this[0] && (yt.isFunction(t) && (t = t.call(this[0])),
                                ...
                                e = function(t) {
                                    return function() {
                                        e && (e = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null,
                                            "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(ze[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                                binary: a.response
                                            } : {
                                                text: a.responseText
            ...
            yt.ajaxSetup({
                ...
                yt.ajaxPrefilter("json jsonp", function(t, e, i) {
                    ...
                    if (a || "jsonp" === t.dataTypes[0])
                        return o = t.jsonpCallback = yt.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                            a ? t[a] = t[a].replace(Xe, "$1" + o) : !1 !== t.jsonp && (t.url += (Ne.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
                            t.converters["script json"] = function() {
                                return s || yt.error(o + " was not called"),
                                    s[0]
                            }
                            ,
                            t.dataTypes[0] = "json",
                ...
                yt.parseHTML = function(t, e, n) {
                    ...
                    "boolean" == typeof e && (n = e,
                        e = !1);
                    var i, o, r;
                    return e || (vt.createHTMLDocument ? (e = st.implementation.createHTMLDocument(""),
                        i = e.createElement("base"),
                        i.href = st.location.href,
                        e.head.appendChild(i)) : e = st),
                        o = $t.exec(t),
                        r = !n && [],
                        o ? [e.createElement(o[1])] : (o = k([t], e, r),
                ...
                yt.each({
                    ...
                    yt.fn[t] = function(i) {
                        return qt(this, function(t, i, o) {
                            var r;
                            if (yt.isWindow(t) ? r = t : 9 === t.nodeType && (r = t.defaultView),
                            void 0 === o)
                                return r ? r[e] : t[i];
                ...
                yt.each(["top", "left"], function(t, e) {
                    yt.cssHooks[e] = R(vt.pixelPosition, function(t, n) {
                        if (n)
                            return n = q(t, e),
                                ue.test(n) ? yt(t).position()[e] + "px" : n
                    })
                }),
                yt.each({
                    Height: "height",
                    ...
                    yt.each({
                        ...
                        yt.fn[i] = function(o, r) {
                            ...
                            return qt(this, function(e, n, o) {
                                var r;
                                return yt.isWindow(e) ? 0 === i.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (r = e.documentElement,
                                    Math.max(e.body["scroll" + t], r["scroll" + t], e.body["offset" + t], r["offset" + t], r["client" + t])) : void 0 === o ? yt.css(e, n, a) : yt.style(e, n, o, a)
                            }, e, s ? o : void 0, s)
                        }
                    })
                }),
                    ...
                    return o(t, [{
                        ...
                        value: function(t, e) {
                            ...
                            this.timeout = setTimeout(function() {
                                ...
                                n.timeout = setTimeout(function() {
                                    n.toggleBlinking(!1),
                                        e === t.length ? n.doneTyping(t, e) : n.keepTyping(t, e, o),
